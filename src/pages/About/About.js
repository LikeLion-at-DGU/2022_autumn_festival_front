...
export default function About() {
  return (
    <div>
      ...
      학우 여러분들의 편의를 위해 동국대 멋쟁이사자처럼이 축제 웹사이트를 개발하였습니다.<br></br><br></br>
      ...
      <SubTitle><br></br><br></br>[ 만든이들 ]</SubTitle>
      <br></br><br></br>
      <LogoImage src={dguLogo} />
      ...
      <Card>
        ...
        <CardLine/>
        <CardText>- 메인페이지, 타임테이블 디자인 <br></br>- 2차 디자인 전반 수정</CardText>  
      </Card>
      <Card>
        <FaceImg src={aboutFace} />
        <CardName>🦁이여원</CardName>
      ...
      {/* 프론트 */}
      <TeamText> .</TeamText>
      <TeamText><br></br><br></br>프론트 개발 팀</TeamText>
      <Card>
        <FaceImg src={aboutFace} />
        <CardName>🦁이여원</CardName>
        <CardMajor>멀티미디어공학과 20</CardMajor>
      ...
      {/* 백 */}
      <TeamText>.</TeamText>
      <TeamText><br></br><br></br>백엔드 개발 팀</TeamText>
      <Card>
        <FaceImg src={aboutFace} />
        <CardName>🦁이여원</CardName>
        <CardMajor>멀티미디어공학과 20</CardMajor>
