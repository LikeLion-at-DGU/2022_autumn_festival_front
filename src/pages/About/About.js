...
export default function About() {
  return (
    <div>
      ...
      <Title>About</Title>      
      <div className='about_logo'><br></br>멋쟁이사자처럼 x 축제기획단</div>
      <div className='about_explain'> <br></br>
      3년만에 돌아온 동국대학교 대동제를 위해 동국대학교 축제기획단이 힘껏 열정을 쏟아 축제를 기획하고 학우 여러분들의 편의를 위해 동국대 멋쟁이사자처럼이 축제 웹사이트를 개발하였습니다.
      오랜만에 열리는 축제인 만큼 학우 여러분들께서 즐겁고 행복한 축제가 되었으면 좋겠습니다! 학우 여러분의 청춘을 응원합니다! :&#41;
      </div>
