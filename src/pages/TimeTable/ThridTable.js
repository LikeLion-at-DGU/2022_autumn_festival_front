...
import Yoon from '../../assets/img/timetableAliee.png';
import Hynn from '../../assets/img/timetable10cm.png';
import Dvwn from '../../assets/img/timetableDVWN.png';
import Itzy from '../../assets/img/timtableZICO.png';
  ...
  return (
    <Container variants={boxVariants} initial="start" animate="end">
      <BoothBox>
        ...
        {/* Booth 두번째 */}
        <BoothItem variants={childVariants} style={{ marginTop: '100px' }}>
          <BoothInfoContainer>
      ...
      <PerFormBox>
        ...
        <PerBox variants={childVariants} style={{ marginTop: '160px' }}>
          <PerPoint />
          <PerInfoContainer>
            <PerInfoTime>14:00 - 18:00</PerInfoTime>
            <PerInfoBox>
              <PerInfoItem>
                <PerInfoItemTitle>가요제</PerInfoItemTitle>
                <PerInfoItemSub>
                  <img src={PinImg} />
                  <span>대운동장</span>
                </PerInfoItemSub>
        ...
        {/* Performance 두번쨰 */}
        <PerBox variants={childVariants} style={{ marginTop: '70px' }}>
          <PerPoint />
          <PerInfoContainer>
            <PerInfoTime>18:00 - 20:30</PerInfoTime>
            <PerInfoBox>
              <PerInfoItem>
                <PerInfoItemTitle>백상공연</PerInfoItemTitle>
                <PerInfoItemSub>
                  <img src={PinImg} />
                  <span>대운동장</span>
                </PerInfoItemSub>
        ...
        <PerBox variants={childVariants} style={{ marginTop: '70px' }}>
          <PerPoint />
          <PerInfoContainer>
            <PerInfoTime>20:30 - 22:00 ~</PerInfoTime>
            <PerInfoBox>
              <PerInfoItem>
                ...
                <PerChart2>
                  ...
                  <PerChart2Item style={{ marginTop: '-10px' }}>
                    <StarImg src={Hynn} />
                    <StarName>10CM</StarName>
                  </PerChart2Item>
                  <PerChart2Item style={{ marginTop: '-10px' }}>
                    <StarImg src={Dvwn} />
                    <StarName>DVWN</StarName>
                  </PerChart2Item>
                  <PerChart2Item style={{ marginTop: '-10px' }}>
                    <StarImg src={Itzy} />
                    <StarName>ZICO</StarName>
                  </PerChart2Item>
                </PerChart2>
              </PerInfoItem>
            </PerInfoBox>
